...
type SelectedPhoto = { uri: string; name: string };
...
export default function RepairRequestScreen() {
  ...
  async function pickPhoto() {
    try {
      ...
      setSelectedPhoto({ uri: photo.uri, name: photo.name || 'Selected photo' });
    } catch {
      Alert.alert('Unable to select photo', 'Please try choosing the image again.');
    }
  }
