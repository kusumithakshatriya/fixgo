...
export default function OffersScreen() { return <View style={styles.page}><SafeAreaView style={styles.content}><ThemedText style={styles.title}>Offers & Wallet</ThemedText><ThemedText style={styles.copy}>Your available offers and wallet details will appear here.</ThemedText></SafeAreaView><FixGoBottomNav active="offers" /></View>; }
