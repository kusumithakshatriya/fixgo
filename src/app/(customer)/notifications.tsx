...
export default function CustomerNotificationsScreen() {
  ...
  const getIconForType = (type: string) => {
    switch(type) {
      case 'booking_assigned': return 'person.fill';
      case 'booking_accepted': return 'checkmark.circle.fill';
      case 'technician_on_the_way': return 'car.fill';
      case 'technician_arrived': return 'mappin.circle.fill';
      case 'service_started': return 'wrench.and.screwdriver.fill';
      case 'additional_charge_requested': return 'indianrupeesign.circle.fill';
      case 'booking_cancelled': return 'xmark.circle.fill';
      case 'payment_completed': return 'indianrupeesign.circle.fill';
      case 'refund_completed': return 'arrow.uturn.left.circle.fill';
